...
**Cloud Support Engineer | IT Support Specialist | AWS Certified**

📍 Dallas-Fort Worth Metroplex • Open to Remote, U.S.
📧 joegreenwood.tech@gmail.com
🔗 [LinkedIn](https://linkedin.com/in/joegreenwood7)
...
**Cloud:** AWS (EC2, S3, RDS, VPC, IAM, CloudFront, CloudWatch, Route 53)
**IaC & Automation:** Terraform, GitHub Actions, AWS CLI, Bash
**Operating Systems:** Linux (Ubuntu), Windows, macOS
**Databases & Web:** MySQL, Amazon RDS, Nginx, PHP
**Tools:** Git, GitHub, VS Code

## Let's Connect

Open to opportunities in Cloud Support, Technical Support, and IT roles. Best way to reach me is email or LinkedIn.

📧 joegreenwood.tech@gmail.com
🔗 [linkedin.com/in/joegreenwood7](https://linkedin.com/in/joegreenwood7)
